...
- **Auto-enable Reader mode for Archived pages** \- From settings page, enable the option to automatically open "Reader mode" for archived pages which support Firefox's reader mode. (Not available in Chrome, Firefox Android)
...
- From settings page, you can enable the option to automatically open "Reader mode" for archived pages which support Firefox's reader mode. (Not available in Firefox Android, Chrome, Opera and Vivaldi)
